<template>
    <div class="aboutUs">
        ...
        <!-- <div class="content relXYData">
            <h3>{{relXYData.typeName}}</h3>
            <div class="abCont">
                <div class="item"><img :src="relXYData.img" /></div>
                <div class="item" v-html="relXYData.content"></div>
            </div>
        </div> -->
...
.infoTitle{color: $C43bee3;font-size: 18px;padding: 10% 0;}
.infoImg{
    // height: 100px;
...
.item_1{
    .item{
        width:50%;
        line-height: 30px;
        img{width: 60%;margin-left: 20%;}
    }
    .title{font-size: 20px !important;color: $C43bee3;}
    .infoContent{font-size: 18px;line-height: 30px;}
